...
// });
  ...
  var peterPan = new Person({
  name: "Peter Pan",
  age:35,
  favoriteFoods:["idly", "poori", "dosa"]
})

var createAndSavePerson = function(done) {
  
  peterPan.save(function(err,data){
...
var arrayOfPeople =[{name:"Peter Schiff",age:40,favoriteFoods:["pasta"]},{name:"Shravan",age:15,favoriteFoods:["idly", "poori", "dosa"]}]
...
var removeManyPeople = function(done) {
  ...
  var toRemove = {name:nameToRemove}
Person.remove(toRemove,(err,data)=>{
if (err) data(err);
  return done(null,data);  
})
};
